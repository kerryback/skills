...
| [`poll`](./plugins/poll/skills/poll) | Live in-class polls on the projector — multiple choice, word clouds, scales, numeric estimates, rankings. Claude writes the questions; students answer anonymously from their own devices. Needs `cloudflared`. |
